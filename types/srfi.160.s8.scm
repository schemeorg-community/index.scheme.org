(((name . "make-s8vector") (signature lambda ((integer? size)) s8vector?))
 ...
 ((name . "s8vector-copy")
  (signature
   lambda
   ((s8vector? vec) (integer? start) (integer? end))
   s8vector?)
  (tags pure))
 ...
 ((name . "s8vector-swap!")
  (signature
   ...
   undefined))
 ((name . "s8vector-fill!")
  (signature lambda ((s8vector? s8vector) (s8? fill)) undefined))
 ((name . "s8vector-fill!")
  (signature
   lambda
   ((s8vector? s8vector) (s8? fill) (integer? start))
   undefined))
 ((name . "s8vector-fill!")
  (signature
   lambda
 ...
 ((name . "s8vector-reverse!")
  (signature lambda ((s8vector? s8vector)) undefined))
 ((name . "s8vector-reverse!")
