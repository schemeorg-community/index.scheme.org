(
 ...
 ((name . f64vector-unfold)
  ...
  (subsigs
    (f (lambda ((integer? index) state) (values f64? *))))
  (tags pure))
 ((name . f64vector-unfold)
  (signature lambda ((procedure? f) (integer? length) seed) f64vector?)
  (subsigs
 ...
 ((name . f64vector-copy)
  ...
  (tags pure))
 ((name . f64vector-copy)
  (signature lambda ((f64vector? vec) (integer? start) (integer? end)) f64vector?)
  (tags pure))
 ...
 ((name . f64vector-append-subvectors)
  (signature lambda ((f64vector? vec1) (integer? start1) (integer? start2) ...) f64vector?)
  (tags pure))
 ...
 ((name . f64vector-skip-right)
  ...
  (subsigs (pred? (lambda (obj1 obj2 ...) *))))
 ((name . f64vector-any)
  (signature lambda ((procedure? pred?) (f64vector? vec1) (f64vector? vec2) ...) *)
  (tags pure)
  (subsigs (pred? (lambda (obj1 obj2 ...) *))))
 ...
 ((name . f64vector-fill!) (signature lambda ((f64vector? f64vector) (f64? fill)) undefined))
 ((name . f64vector-fill!)
  (signature lambda ((f64vector? f64vector) (f64? fill) (integer? start)) undefined))
 ((name . f64vector-fill!)
  (signature
   lambda
   ((f64vector? f64vector) (f64? fill) (integer? start) (integer? end))
   undefined))
 ((name . f64vector-reverse!) (signature lambda ((f64vector? f64vector)) undefined))
 ...
 ((name . f64vector-reverse!)
  (signature
   ...
   undefined))
 ((name . f64vector-copy!)
  (signature lambda ((f64vector? to) (integer? at) (f64vector? from)) undefined))
 ((name . f64vector-copy!)
  (signature
   lambda
 ...
 ((name . f64vector-copy!)
  (signature
   lambda
   ((f64vector? to) (integer? at) (f64vector? from) (integer? start) (integer? end))
   undefined))
 ((name . f64vector-reverse-copy!)
  (signature lambda ((f64vector? to) (integer? at) (f64vector? from)) undefined))
 ((name . f64vector-reverse-copy!)
 ...
 ((name . make-f64vector-generator)
  ...
  (subsigs
    (return (lambda () (or eof-object? f64?)))))
