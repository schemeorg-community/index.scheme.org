(((name . "boolean-compare")
 ...
 ((name . "vector-compare")
  ...
  (subsigs (compare (lambda (el1 el2) integer?)))
  (tags pure))
 ((name . "vector-compare")
  (signature lambda (x y (procedure? size) (procedure? ref)) integer?)
  (subsigs (size (lambda (seq) integer?)) (ref (lambda (seq index) *)))
  (tags pure))
 ((name . "vector-compare")
  (signature
   lambda
   ((procedure? compare) x y (procedure? size) (procedure? ref))
   integer?)
  (subsigs
 ...
 ((name . "list-compare")
  (signature
   lambda
   (x y (procedure? empty?) (procedure? head) (procedure? tail))
   integer?)
  (subsigs
 ...
 ((name . "pair-compare")
  ...
  (tags pure))
 ((name . "pair-compare") (signature lambda (obj1 obj2) integer?) (tags pure))
 ((name . "pair-compare")
 ...
 ((name . "=?")
  ...
  (subsigs (return (lambda (x y) boolean?)))
  (tags pure))
 ((name . "=?")
  (signature lambda ((procedure? compare)) procedure?)
  (subsigs (compare (lambda (x y) integer?)) (return (lambda (x y) boolean?)))
  (tags pure))
 ((name . "=?") (signature lambda (x y) boolean?) (tags pure))
 ((name . "=?")
 ...
 ((name . "not=?")
  ...
  (subsigs (compare (lambda (x y) integer?)) (return (lambda (x y) boolean?)))
  (tags pure))
 ((name . "not=?") (signature lambda (x y) boolean?) (tags pure))
 ((name . "not=?")
  (signature lambda ((procedure? compare) x y) boolean?)
  (subsigs (compare (lambda (x y) integer?)))
  (tags pure))
 ((name . "</<?")
  (signature lambda () procedure?)
  (subsigs (return (lambda (x y z) boolean?)))
  (tags pure))
 ((name . "</<?")
  (signature lambda ((procedure? compare)) procedure?)
  (subsigs
  ...
  (tags pure))
 ((name . "</<?") (signature lambda (x y z) boolean?) (tags pure))
 ((name . "</<?")
 ...
 ((name . "compare-by<")
  ...
  (subsigs (lt-pred (lambda (x y) boolean?)) (return (lambda (x y) integer?)))
  (tags pure))
 ((name . "compare-by<")
 ...
 ((name . "compare-by>")
  ...
  (subsigs (gt-pred (lambda (x y) boolean?)) (return (lambda (x y) integer?)))
  (tags pure))
 ((name . "compare-by>")
 ...
 ((name . "compare-by<=")
  ...
  (subsigs (le-pred (lambda (x y) boolean?)) (return (lambda (x y) integer?)))
  (tags pure))
 ((name . "compare-by<=")
 ...
 ((name . "compare-by>=")
  ...
  (subsigs (ge-pred (lambda (x y) boolean?)) (return (lambda (x y) integer?)))
  (tags pure))
 ((name . "compare-by>=")
