(((name . bitwise-not) (signature lambda ((integer? i)) integer?) (tags pure))
 ...
 ((name . bitwise-if)
  ...
  (tags pure))
 ((name . bitwise-bit-count) (signature lambda ((integer? i)) integer?) (tags pure))
 ((name . bitwise-length)
  (signature lambda ((integer? i)) integer?)
  (tags pure))
 ...
 ((name . bitwise-copy-bit)
  (signature
    lambda
    ((integer? i) (integer? index) (integer? from))
    integer?)
  (tags pure))
 ...
 ((name . bitwise-copy-bit-field)
  (signature lambda ((integer? i) (integer? start) (integer? end) (integer? from)) integer?)
  (tags pure))
 ...
 ((name . bitwise-rotate-bit-field)
  (signature lambda ((integer? i) (integer? from) (integer? to) (integer? count)) integer?)
  (tags pure))
