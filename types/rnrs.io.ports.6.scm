(((name . &i/o)
 ...
 ((name . error-handling-mode)
  ...
  (spec-values
    (error-handling-mode-symbol
      ("ignore" "appropriate number of bytes of the invalid encoding are ignored and decoding continues with the following bytes")
      ("raise" "exception with condition type &i/o-decoding is raised")
      ("replace" "the replacement character U+FFFD is injected into the data stream, an appropriate number of bytes are ignored, and decoding continues with the following bytes"))))
 ((name . make-transcoder)
  (signature lambda ((codec codec)) transcoder))
 ((name . make-transcoder)
  (signature lambda ((codec codec) (symbol? eol-style)) transcoder))
 ((name . make-transcoder)
  (signature lambda ((codec codec) (symbol? eol-style) (symbol? handling-mode)) transcoder))
 ((name . native-transcoder)
  (signature lambda () transcoder))
 ...
 ((name . port-transcoder) (signature lambda ((port? port)) transcoder) (tags pure))
 ((name . textual-port?)
  (signature lambda (obj) boolean?)
  (tags pure predicate)
  (supertypes port?))
 ...
 ((name . transcoded-port)
  (signature lambda ((binary-port? port) (transcoder transcoder)) textual-port?))
 ((name . port-has-port-position?)
  (signature lambda ((port? port)) boolean?)
  (tags pure))
 ((name . port-position)
  (signature lambda ((binary-port? port)) integer?))
 ((name . port-position)
 ...
 ((name . set-port-position!)
  (signature lambda ((textual-port? port) (opaque-port-position pos)) undefined))
 ...
 ((name . open-file-input-port) (signature lambda ((string? string)) input-port?))
 ((name . open-file-input-port) (signature lambda ((string? string) (file-options options)) input-port?))
 ((name . open-file-input-port) (signature lambda ((string? string) (file-options options) (buffer-mode? buffer-mode)) input-port?))
 ((name . open-file-input-port)
  (signature lambda ((string? string) (file-options options) (buffer-mode? buffer-mode) ((or #f transcoder) transcoder)) input-port?))
 ((name . open-bytevector-input-port)
  (signature lambda ((bytevector? bytevector)) input-port?))
 ((name . open-bytevector-input-port)
  (signature lambda ((bytevector? bytevector) ((or #f transcoder) transcoder)) input-port?))
 ...
 ((name . make-custom-binary-input-port)
  (signature lambda ((string? id) (procedure? read!) ((or #f procedure?) get-position) ((or #f procedure?) set-position!) ((or #f procedure?) close)) input-port?)
  (subsigs
    (read! (lambda ((bytevector? bytevector) (integer? start) (integer? count)) integer?))
 ...
 ((name . make-custom-textual-input-port)
  (signature lambda ((string? id) (procedure? read!) ((or #f procedure?) get-position) ((or #f procedure?) set-position!) ((or #f procedure?) close)) input-port?)
  (subsigs
    (read! (lambda ((string? string) (integer? start) (integer? count)) integer?))
 ...
 ((name . get-bytevector-n)
  (signature lambda ((input-port? input-port) (integer? count)) (or eof-object? bytevector?)))
 ((name . get-bytevector-n!)
  (signature lambda ((input-port? input-port) (bytevector? bytevector) (integer? start) (integer? count)) (or integer? eof-object?)))
 ...
 ((name . lookahead-char)
  (signature lambda ((input-port? input-port)) (or eof-object? char?)))
 ((name . get-string-n)
  (signature lambda ((input-port? input-port) (integer? count)) (or eof-object? string?)))
 ((name . get-string-n!)
  (signature lambda ((input-port? input-port) (string? string) (integer? start) (integer? count)) (or eof-object? integer?)))
 ((name . get-string-all)
 ...
 ((name . open-file-output-port)
  (signature lambda ((string? filename) (file-options file-options)) output-port?))
 ((name . open-file-output-port)
  (signature lambda ((string? filename) (file-options file-options) (buffer-mode? buffer-mode)) output-port?))
 ((name . open-file-output-port)
  (signature lambda ((string? filename) (file-options file-options) (buffer-mode? buffer-mode) ((or transcoder #f) maybe-transcoder)) output-port?))
 ((name . open-bytevector-output-port)
  (signature lambda () (values output-port? procedure?))
  (subsigs
    (return (lambda () bytevector?))))
 ((name . open-bytevector-output-port)
  (signature lambda (((or #f transcoder) maybe-transcoder)) (values output-port? procedure?))
  (subsigs
    (return (lambda () bytevector?))))
 ...
 ((name . call-with-bytevector-output-port)
  (signature lambda ((procedure? proc) ((or #f transcoder) maybe-transcoder)) bytevector?)
  (subsigs
    (proc (lambda ((output-port? port)) *))))
 ...
 ((name . make-custom-binary-output-port)
  (signature lambda ((string? id) (procedure? write!) ((or #f procedure?) get-position) ((or #f procedure?) set-position!) ((or #f procedure?) close)) output-port?)
  (subsigs
    (write! (lambda ((bytevector? bytevector) (integer? start) (integer? count)) integer?))
    (get-position (lambda () integer?))
    (set-position! (lambda ((integer? position)) undefined))
    (close (lambda () undefined))))
 ((name . make-custom-textual-output-port)
  (signature lambda ((string? id) (procedure? write!) ((or #f procedure?) get-position) ((or #f procedure?) set-position!) ((or #f procedure?) close)) output-port?)
  (subsigs
    (write! (lambda ((string? string) (integer? start) (integer? count)) integer?))
    (get-position (lambda () integer?))
    (set-position! (lambda ((integer? position)) undefined))
    (close (lambda () undefined))))
 ((name . put-u8)
 ...
 ((name . put-bytevector)
  (signature lambda ((output-port? port) (bytevector? bytevector) (integer? start)) undefined))
 ((name . put-bytevector)
  (signature lambda ((output-port? port) (bytevector? bytevector) (integer? start) (integer? count)) undefined))
 ((name . put-char)
  (signature lambda ((output-port? port) (char? char)) undefined))
 ((name . put-string)
  (signature lambda ((output-port? port) (string? string)) undefined))
 ((name . put-string)
  (signature lambda ((output-port? port) (string? string) (integer? start)) undefined))
 ((name . put-string)
  (signature lambda ((output-port? port) (string? string) (integer? start) (integer? count)) undefined))
 ((name . put-datum)
  (signature lambda ((output-port? port) datum) undefined))
 ((name . open-file-input/output-port) (signature lambda ((string? string)) port?))
 ((name . open-file-input/output-port) (signature lambda ((string? string) (file-options options)) port?))
 ((name . open-file-input/output-port) (signature lambda ((string? string) (file-options options) (buffer-mode? buffer-mode)) port?))
 ((name . open-file-input/output-port)
  (signature lambda ((string? string) (file-options options) (buffer-mode? buffer-mode) ((or #f transcoder) transcoder)) port?))
 ((name . make-custom-binary-input/output-port)
  (signature lambda ((string? id) (procedure? read!) (procedure? write!) ((or #f procedure?) get-position) ((or #f procedure?) set-position!) ((or #f procedure?) close)) port?)
  (subsigs
    (read! (lambda ((bytevector? bytevector) (integer? start) (integer? count)) integer?))
    (write! (lambda ((bytevector? bytevector) (integer? start) (integer? count)) integer?))
    (get-position (lambda () integer?))
