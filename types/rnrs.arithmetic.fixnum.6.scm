(((name . fixnum?)
 ...
 ((name . fxdiv) (signature lambda ((fixnum? x1) (fixnum? x2)) fixnum?) (tags pure))
 ((name . fxdiv0) (signature lambda ((fixnum? x1) (fixnum? x2)) fixnum?) (tags pure))
 ((name . fxdiv-and-mod) (signature lambda ((fixnum? x1) (fixnum? x2)) (values fixnum? fixnum?)) (tags pure))
 ((name . fxdiv0-and-mod0) (signature lambda ((fixnum? x1) (fixnum? x2)) (values fixnum? fixnum?)) (tags pure))
 ((name . fxmod) (signature lambda ((fixnum? x1) (fixnum? x2)) fixnum?) (tags pure))
 ((name . fxmod0) (signature lambda ((fixnum? x1) (fixnum? x2)) fixnum?) (tags pure))
 ((name . fx+/carry)
  (signature
   lambda
 ...
 ((name . fxbit-set?)
  ...
  (tags pure))
 ((name . fxcopy-bit)
  (signature lambda ((fixnum? i) (fixnum? index) (fixnum? replacement)) fixnum?)
  (tags pure))
 ((name . fxbit-field)
  (signature lambda ((fixnum? i) (fixnum? start) (fixnum? end)) fixnum?)
  (tags pure))
 ((name . fxcopy-bit-field)
  (signature lambda ((fixnum? i) (fixnum? start) (fixnum? end) (fixnum? replacement)) fixnum?)
  (tags pure))
 ...
 ((name . fxrotate-bit-field)
  (signature lambda ((fixnum? i) (fixnum? from) (fixnum? to) (fixnum? count)) fixnum?)
  (tags pure))
