(((name . "make-c128vector") (signature lambda ((integer? size)) c128vector?))
 ...
 ((name . "c128vector-copy")
  (signature
   lambda
   ((c128vector? vec) (integer? start) (integer? end))
   c128vector?)
  (tags pure))
 ...
 ((name . "c128vector-fill!")
  (signature lambda ((c128vector? c128vector) (c128? fill)) undefined))
 ((name . "c128vector-fill!")
  (signature
   lambda
   ((c128vector? c128vector) (c128? fill) (integer? start))
   undefined))
 ((name . "c128vector-fill!")
  (signature
   lambda
 ...
 ((name . "c128vector-reverse!")
  (signature lambda ((c128vector? c128vector)) undefined))
 ((name . "c128vector-reverse!")
 ...
 ((name . "c128vector-copy!")
  (signature
   lambda
   ((c128vector? to) (integer? at) (c128vector? from))
   undefined))
 ((name . "c128vector-copy!")
  (signature
   lambda
 ...
 ((name . "vector->c128vector")
  (signature
   lambda
   ((vector? vec) (integer? start) (integer? end))
   c128vector?)
  (tags pure))
